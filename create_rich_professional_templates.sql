-- Create 8 Rich Professional Templates with ALL Element Types
-- These templates showcase the full range of available elements
...
BEGIN
    ...
    -- First delete existing templates in Standaard library to replace them
